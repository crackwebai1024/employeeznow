...
const SearchForm = ({
  ...
  const [shift, setShift] = useState(
    searchFormData ? searchFormData.shift : []
  );
  const [reload, setReload] = useState(false);
  const [error, setError] = useState("");
  const [loading, setLoading] = useState(false);
  const [style, setStyle] = useState(
    searchFormData ? searchFormData.style : []
  );
  const [cuisine, setCuisine] = useState(
    searchFormData ? searchFormData.cuisine : []
  );
  ...
  return (
    <Fragment>
      ...
      <Container
        maxWidth="sm"
        style={loading ? { overflowY: "hidden" } : { overflowY: "scroll" }}
      >
            ...
            <Grid container direction="row" spacing={2}>
              ...
              <Grid item xs={12} sm={12}>
                <TextField
                  ...
                  helperText={
                    errors.minimumexp && errors.minimumexp
                      ? "This filed is required"
                      : ""
                  }
                  type="number"
              ...
              <Grid item xs={12}>
                ...
                />
                <Typography className={classes.error}>{styleError}</Typography>
              </Grid>
              ...
              <Grid item xs={12}>
                <Autocomplete
                  ...
                  helperText={
                    cuisineError ? "You can only select 3 items." : ""
                  }
                  size="small"
                  name="cuisine"
                  options={cuisines}
                  ...
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      variant="outlined"
                      label="PREFERRED CUISINE EXPERIENCE"
                      InputLabelProps={{ shrink: true }}
                    />
                  )}
                />
              ...
              <Grid item xs={12}>
                <TextField
                  error={
                    errors.reservation && errors.reservation ? true : false
                  }
                  helperText={
                  ...
                  margin="none"
                  name="reservation"
                  label="RESERVATION SYSTEM EXPERIENCE"
                  InputLabelProps={{ shrink: true }}
                  variant="outlined"
                  SelectProps={{ native: true }}
                  size="small"
...
const mapStateToProps = ({ employer: { saveFilter } }) => ({
  saveFilter,
});
