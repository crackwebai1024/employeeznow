...
const EmailVerification = ({ isEmailCodeError, actions, signupUser }) => {
  ...
  useEffect(() => {
    if (isEmailCodeError) setError("Please Input correct 6 Digit code!");
  }, [isEmailCodeError]);
      ...
      <Grid container direction="column" justify="center" alignItems="center">
        ...
        <Fragment>
          <Typography className={classes.description}>
            We sent 6 digit code to your email. Please Input the digit code.
          </Typography>
          <ReactCodeInput
            type="text"
            fields={6}
...
const mapStateToProps = ({ auth: { isEmailCodeError, signupUser } }) => ({
  isEmailCodeError,
  signupUser,
});
