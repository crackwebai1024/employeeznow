    ...
    <Fragment>
      ...
      <Grid container item xs={12}>
        <Grid item xs={12} sm={6} className={classes.col_center}>
          <Box style={{ margin: "auto" }}>
            ...
            <Typography className={classes.profileSubdescription}>
              ...
              multiple sites just to get a list of qualified candidates.
              Register your company profile & get your candidates in just a few
              minutes!
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={12} sm={6} className={classes.center}>
          <img
            src={`${process.env.PUBLIC_URL}/img/test/img4.png`}
            alt="img"
      ...
      <Grid item xs={12}>
        <Box className={classes.listDescription}>
          {listData.map((list, key) => {
            return (
              <Box style={{ display: "flex" }} key={key}>
                <img
                  src={`${process.env.PUBLIC_URL}/img/test/arrow.svg`}
                  alt="arrow"
          ...
          <Box className={classes.bottomDescription}>
            EmployeezNow will reduce the time and cost it takes to hire by 50%
            or more!
          </Box>
        </Box>
      </Grid>
